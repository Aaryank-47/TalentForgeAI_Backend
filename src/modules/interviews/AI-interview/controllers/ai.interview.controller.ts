...
export class AIInterviewController {
    static generateQuestions = asyncHandler(
        async (req: Request, res: Response) => {
            ...
            const question = await AIQuestionService.generateFirstQuestion(sessionId as string);
    ...
    static getFinalResult = asyncHandler(
        async (req: Request, res: Response) => {
            ...
            const report = await AIInterviewFinalEvaluationService.getFinalReport(sessionId as string);
