...
describe("Matching API & Service Integration Tests", () => {
    ...
    describe("Candidate Matched Jobs API", () => {
            ...
            const mockMatches = [
                {
                    ...
                    semanticScore: 95,
                    matchingFactors: { skills: { score: 38 } } as any,
        ...
        it("should throw NotFoundError if candidate profile does not exist", async () => {
            jest.spyOn(AuthRepository, "findProfileByUserId").mockResolvedValue(null as any);

            await expect(
                MatchingService.getMatchedJobsForCandidate("non_existent_user")
    ...
    describe("Recruiter Matched Candidates API", () => {
            ...
            const mockCandidates = [
                {
                    ...
                    semanticScore: null,
                    matchingFactors: { skills: { score: 35 } } as any,
                    status: "CURRENT" as const,
                    calculatedAt: new Date().toISOString(),
                    candidate: {
                        id: "cand_1",
        ...
        it("should reject unauthorized recruiter accessing another company's job", async () => {
            ...
            await expect(
                MatchingService.getMatchedCandidatesForJob("job_1", "unauthorized_user", "comp_1")
