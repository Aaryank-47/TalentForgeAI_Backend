...
export interface RecruiterMatchedCandidateView {
    ...
    candidate: {
        ...
        preferredLocation: string | null;
        isOpenToWork: boolean;
        skills: Array<{ id: string; name: string; yearsOfExperience: number | null }>;
        educations: Array<{ id: string; collegeName: string; degree: string; fieldOfStudy: string }>;
        experiences: Array<{ id: string; companyName: string; designation: string; startDate: string; endDate: string | null; currentlyWorking: boolean }>;
    };
}
