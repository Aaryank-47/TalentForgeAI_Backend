...
} from "./resume-processing.queue.js";
import {
    getResumeProcessingWorker,
    ResumeProcessingWorker
} from "./resume-processing.worker.js";

// Initializes the resume processing background worker.
export function initResumeProcessingWorker(): ResumeProcessingWorker {
...
export async function shutdownResumeProcessing(): Promise<void> {
