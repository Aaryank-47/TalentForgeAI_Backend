...
export class emailTemplates {
    private static readonly companyAddress = "123 Tech Lane, San Francisco, CA 94105"; // Replace with your actual physical address
    private static readonly baseUnsubscribeLink = `${env.app.frontendUrl}/unsubscribe`;

    private static getFooterHtml(unsubscribeLink: string): string {
        return `
    ...
    private static getFooterText(unsubscribeLink: string): string {
    ...
    static existingUserInvitationTemplate = (
        companyName: string,
        inviterName: string,
        role: string,
    ...
    static newUserInvitationTemplate = (
        companyName: string,
        inviterName: string,
        role: string,
        invitationLink: string
