...
export const forgotPasswordRateLimiter =
    createRateLimiter(
        RATE_LIMIT.FORGOT_PASSWORD.WINDOW_MS,
        RATE_LIMIT.FORGOT_PASSWORD.MAX_REQUESTS,
        "Too many password reset requests."
    );

export const verifyOtpRateLimiter =
    createRateLimiter(
        RATE_LIMIT.VERIFY_OTP.WINDOW_MS,
        RATE_LIMIT.VERIFY_OTP.MAX_REQUESTS,
        "Too many OTP verification attempts."
    );

export const resendVerificationRateLimiter =
    createRateLimiter(
        RATE_LIMIT.RESEND_VERIFICATION.WINDOW_MS,
        RATE_LIMIT.RESEND_VERIFICATION.MAX_REQUESTS,
        "Too many resend verification requests."
    );

export const globalRateLimiter =
    createRateLimiter(
        RATE_LIMIT.GLOBAL.WINDOW_MS,
        RATE_LIMIT.GLOBAL.MAX_REQUESTS,
        "Too many requests."
    );