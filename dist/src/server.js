...
import { OpensearchService } from './modules/company/services/opensearch.service.js';
import { MatchingOpensearchService } from './modules/matching/services/matching-opensearch.service.js';
...
async function startServer() {
    ...
    try {
        ...
        console.log("[Startup] Ensuring OpenSearch index...");
        await OpensearchService.ensureIndex();
        console.log("[Startup] OpenSearch index ready.");
        console.log("[Startup] Ensuring matching OpenSearch indices...");
        await MatchingOpensearchService.ensureIndices();
        console.log("[Startup] Matching OpenSearch indices ready.");
