...
export class AssessmentOutcomeService {
    static async determineOutcome(attemptId) {
...
export class AssessmentATSIntegrationService {
    static async getAssessmentResultByApplication(userId, role, applicationId) {
        ...
        if (outcome.outcome === "PASSED") {
            if (currentStageIndex !== -1 && currentStageIndex < stages.length - 1) {
                ...
                if (nextStage) {
                    ...
                    await ApplicationWorkflowRepository.updateApplicationWorkflow(employerId, attempt.applicationId, applicationWorkflow.workflowStageId, nextStage.id, `Auto transitioned - Assessment Passed (${attempt.percentage}%)`);
...
//# sourceMappingURL=atsIntegration.service.js.map