...
router.get("/applications/:applicationId/assessment-invitation", authMiddleware, authorize(UserRole.CANDIDATE), validate(applicationIdParamSchema, "params"), JobAssessmentController.getAssessmentInvitation);
