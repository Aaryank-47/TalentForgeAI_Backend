...
ApplicationWorkflowRoutes.get("/:applicationId/workflow", authMiddleware, authorize("EMPLOYER", "ADMIN"), validate(WorkflowDto.applicationIdParam, "params"), ApplicationWorkflowController.getCandidateWorkflow);
ApplicationWorkflowRoutes.get("/:applicationId/workflow/history", authMiddleware, authorize("EMPLOYER", "ADMIN"), validate(WorkflowDto.applicationIdParam, "params"), ApplicationWorkflowController.getWorkflowHistory);
