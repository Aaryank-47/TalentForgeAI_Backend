...
describe("fetchFileBufferFromUrl", () => {
    ...
    it("throws error when HTTP response is not ok", async () => {
        ...
        await expect(fetchFileBufferFromUrl("https://res.cloudinary.com/demo/raw/upload/missing.pdf")).rejects.toThrow("Failed to retrieve file from storage: HTTP 404 Not Found");
    });
    it("throws error when downloaded buffer is empty", async () => {
        ...
        await expect(fetchFileBufferFromUrl("https://res.cloudinary.com/demo/raw/upload/empty.pdf")).rejects.toThrow("Downloaded file buffer is empty");
    });
});
//# sourceMappingURL=file-retrieval.test.js.map