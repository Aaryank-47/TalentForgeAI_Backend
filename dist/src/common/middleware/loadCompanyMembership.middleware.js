...
export const loadCompanyMembership = async (req, res, next) => {
    try {
        const user = req.user;
        if (!user) {
        ...
        const membership = await CompanyRepository.membership(companyId, user.id);
        if (!membership) {
...
//# sourceMappingURL=loadCompanyMembership.middleware.js.map